...
def controller():
    ...
    p = subprocess.run(['gnome-terminal', '--geometry', '135x15', '--title', 'Controller',  '-e', command_DS4])
...
def start_gui():
    ...
    button4 = tk.Button(buttons, text="Keyboard Controller", font=('Ubuntu', 18), width=10, command=lambda: keyboard(),
                        bg="#4F4F94", fg="black", relief=tk.RAISED)
    
    button4.grid(row=0, column=1, sticky=tk.NSEW, padx=10, pady=10)
